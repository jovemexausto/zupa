import { type StateSnapshot, type Checkpointer, type Ledger, type LedgerEvent } from "@zupa/core";
 ...
 */
export class MemoryCheckpointer<TState = Record<string, unknown>>
  implements Checkpointer<TState>, Ledger
{
  ...
  public async getCheckpointById(
    threadId: string,
    checkpointId: string,
