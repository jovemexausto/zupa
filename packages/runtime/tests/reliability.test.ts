...
describe('Zupa Reliability: Idempotency & Resumability', () => {
    ...
    it('should be idempotent: subsequent calls with same messageId do nothing', async () => {
        ...
        const inbound = { ...DEFAULT_INBOUND, from: TEST_USER_FROM, body: 'Hi', messageId: msgId };
    ...
    it('should persist KV state across turns (Durable Scratchpad)', async () => {
        ...
        await runtime.runInbound({ ...DEFAULT_INBOUND, from: TEST_USER_FROM, body: 'Turn 1', messageId: m1 });
        ...
        await runtime.runInbound({ ...DEFAULT_INBOUND, from: TEST_USER_FROM, body: 'Turn 2', messageId: 'm2' });
