...
That's it. Open the URL, scan the code with WhatsApp, start talking to your agent.
...
Every Zupa agent ships with an embedded web UI. No separate process, no config needed.
...
└── ui/
    ├── server.ts            express server, SSE events
    └── static/              single-file embedded UI
```
...
<p align="center">
  Made in Brazil 🇧🇷 · <a href="https://zupa.dev">zupa.dev.br</a> · <a href="https://discord.gg/zupa">Discord</a>
</p>
